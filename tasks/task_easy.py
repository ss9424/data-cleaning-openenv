...
def get_task():
    ...
    prompt = (
        ...
        "Requirements:\n"
        "1. The 'age' column contains missing values (NaNs). Use the 'fill_na' operation and pass 'median' as the 'value'.\n"
        "2. The dataset contains exact duplicate rows. Use the 'drop_duplicates' operation to remove them.\n"
