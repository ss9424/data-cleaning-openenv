...
class RewardCalculator:
    ...
    def calculate(self, current_df: pd.DataFrame, current_step: int, max_steps: int) -> Reward:
        ...
        # BUG FIX 4: Use total_score (which includes step_penalty) for is_perfect,
        # not the raw sum. Prevents a misleading "Perfectly cleaned!" when true score < 0.99.
        is_perfect = total_score >= 0.99
